...
【重要规则】
- 你的主要信息来源是下方「📊 各渠道采集的全景数据」，这些数据来自平方学者库、ORCID、OpenAlex、Wikipedia/百度百科等权威渠道，全部可信可引用。
- 「验真比对结果」是辅助参考。
...
【❗ 核心规则 — 必须严格遵守】
1. 你的主要信息来源是下方「📊 各渠道采集的全景数据」，这些数据来自平方学者库、ORCID、OpenAlex、Wikipedia/百度百科等权威渠道，全部可信可引用，等同于一手事实。
