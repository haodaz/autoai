...
export function ResourceDeepSearchTest() {
  ...
  return (
    <Card title="[Admin] Resource Deep Search 测试台 (科研物资检索与汇报)" style={{ marginBottom: 24, borderColor: '#427759' }}>
      <Space style={{ marginBottom: 24 }} wrap>
        ...
        <Input
          ...
          onPressEnter={handleSearch}
        />
        <Button type="primary" icon={<SearchOutlined />} onClick={handleSearch} loading={loading} style={{ background: '#427759' }}>
          开始资源检索
        </Button>
      </Space>
