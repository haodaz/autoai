      ...
      <div style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        <button
          ...
          style={{
            ...
            background: showProfile ? '#e0e7ff' : '#fff',
            color: showProfile ? '#4338ca' : '#6b7280', fontSize: 12, cursor: 'pointer',
            boxShadow: '0 1px 2px rgba(0,0,0,0.05)'
          }}
        >
      ...
      {showProfile && (
        <textarea
          ...
          style={{
            ...
            border: '1px solid #e5e7eb', background: '#fff',
            color: '#111827', fontSize: 13, outline: 'none', resize: 'vertical',
            boxShadow: '0 1px 2px rgba(0,0,0,0.05)'
          }}
        />
      )}
          ...
          {logsExpanded && (
            <div style={{ flex: 1, overflowY: 'auto', padding: '8px 12px' }}>
              ...
              {logs.length === 0 && !loading && (
                <div style={{ color: '#9ca3af', fontSize: 12, padding: 8 }}>输入政策主题后点击搜索</div>
              )}
            </div>
          )}
        </div>
